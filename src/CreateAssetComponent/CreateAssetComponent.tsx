...
const CreateAssetComponent = (
    ...
    return (
        <div className="create-asset-div">
            ...
            >
                <option value="selectYourOption" disabled>Select your option</option>
            ...
            <input
                ...
                onChange={(e) =>
                    setGroupAndAsset({ ...groupAndAsset, assetDescription: e.target.value })
                }
            />
            <div className="button-div">
                <button className="add-button" onClick={() => props.onAdd(groupAndAsset)}>Add</button>
